...
import com.example.makeorderserverapp.Common.DirectionsJSONParser;
import com.example.makeorderserverapp.Remote.IGeoCordinates;
...
public class TrackingOrder extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        ...
        else
        {
            ...
            if(mLastLocation != null)
            {
                ...
                //Marker order location and route
            ...
            public void onResponse(Call<String> call, Response<String> response) {
                ...
                try {
                    ...
                    MarkerOptions markerOrder = new MarkerOptions().icon(BitmapDescriptorFactory.fromBitmap(bitmap))
                            .title("Order of "+Common.currentRequest.getName()+"("+Common.currentRequest.getPhone()+")")
    ...
    private boolean checkPlayServices() {
        ...
        if(resultCode != ConnectionResult.SUCCESS)
        {
            ...
            {
                Toast.makeText(this, "This device is not supporting google maps!", Toast.LENGTH_SHORT).show();
                finish();
            }
            return false;
        }
